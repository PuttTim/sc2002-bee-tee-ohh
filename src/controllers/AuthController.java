...
public class AuthController {
     ...
     * <ul>
     *     <li>Handles the login process</li>
     *     <li>Prompts the user for login credentials like the user's NRIC and password</li>
    ...
    /**
     * Allows a manager to register officers to handle BTO projects.
     */
